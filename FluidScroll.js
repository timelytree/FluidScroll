var FluidScroll = (function(container, speed) {
  // DISCLAIMER
  // The code below was written by Bartek Drozdz
  ...
  // This function prevents scrolling on touch devices that use touchmove event to scroll
  ...
  VirtualScroll.on(function(e) {
    targetY += e.deltaY;
    targetY = Math.max( (containerHEIGHT - window.innerHeight) * -1, targetY);
    targetY = Math.min(0, targetY);
  });

  // Do the actual scrolling
  var currentY = 0, ease = speed;
  var run = function() {
